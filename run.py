...
def main() -> None:
    ...
    common = dict(
        ...
        unitary_circuit= ["paper_viscid","default_rzrxrz","multiscale_tree_rzrxrz"],#["mps_staircase_light","mps_staircase"],#["all_to_all_crx","block_crx","ring_trainable_crz","ghz_orbit","local_ry_rz"],
